...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.GET_BETWEEN, query = "SELECT m FROM Meal m WHERE m.user.id=:userId AND m.dateTime<:endTime AND m.dateTime>=:startTime ORDER BY m.dateTime")
})
